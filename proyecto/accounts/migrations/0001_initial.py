# Generated by Django 3.1.7 on 2021-06-03 02:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Libros', 'Libros'), ('Novelas', 'Novelas'), ('Historietas', 'Historietas'), ('Periodicos', 'Periodicos')], max_length=200, null=True)),
                ('autor', models.CharField(max_length=200, null=True)),
                ('editorial', models.CharField(max_length=200, null=True)),
                ('edicion', models.CharField(max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.CharField(choices=[('Pendiente', 'Pendiente'), ('Rentado', 'Rentado'), ('Entregado', 'Entregado')], max_length=200, null=True)),
